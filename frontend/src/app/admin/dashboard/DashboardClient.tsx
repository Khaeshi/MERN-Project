...
export default function DashboardClient({ user }: Props) {
  ...
  // ✅ REMOVED: Access denied check - server already verified this
    ...
    return (
      <div className="min-h-screen bg-black-50 flex items-center justify-center">
        <Card className="p-8 text-center">
          <h2 className="text-2xl mb-4">Error Loading Menu</h2>
          <p className="text-black-600 mb-4">{error.message}</p>
  ...
  return (
    <div className="min-h-screen bg-black-50">
      {/* Header */}
      <div className="bg-white border-b border-black-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold">Admin Dashboard</h1>
              <p className="text-black-600 mt-1">Manage your menu items</p>
            </div>
            {/* Welcome Message */}
            <div className="text-right">
              <p className="text-sm text-black-600">Welcome back,</p>
          ...
          <div className="lg:col-span-2">
            ...
            {!menuItems ? (
              <Card className="p-12 text-center">
                <p className="text-black-600">Loading menu items...</p>
              </Card>
            ) : menuItems.length === 0 ? (
              <Card className="p-12 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {menuItems.map((item, index) => (
                  <Card key={item.id || `item-${index}`} className="overflow-hidden hover:shadow-lg transition-shadow">
                    <div className="aspect-video w-full bg-black-100 relative overflow-hidden">
                    ...
                    <CardContent className="p-4">
                      ...
                      <p className="text-black-600 text-sm mb-4 line-clamp-2">
                        {item.description}
                      </p>
