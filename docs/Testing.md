...
Observation:
Cookie successfully set with httpOnly and sameSite options
...
</details> **Pass – Login works correctly, token is generated.**
...
Observation:
Middleware correctly checks password with bcrypt


Proper error returned, login fails as expected


</details> **Pass – Proper error returned for wrong password.**
...
Observation:
Protect middleware correctly verifies JWT only after login


Non-existent email cannot generate token


</details> **Pass – Proper error returned for non-existent email.**
...
Missing fields are caught before JWT/token generation


</details> ✅ **Pass – Proper validation on required fields.**
...
</details> ✅ **Pass – Admin authentication verified, users fetched successfully.**
...
</details> ✅ **Pass – Role updated successfully for another user.**
...
</details> ✅ **Pass – Admin successfully deleted a non-admin user.**
Test Case 8 – Logout
<details> <summary>Request & Response</summary>
...
</details> ✅ **Pass – Logout successfully clears session and token.**
...
</details> ✅ **Pass – Image uploaded correctly.**
...
</details> ✅ **Pass – Images fetched successfully.**
...
</details> ✅ **Pass – Image deleted successfully.**
...
</details> ✅ **Pass – Non-image files rejected successfully.**
...
</details> ✅ **Pass – Oversized files rejected successfully.**
...
</details> ✅ **Pass – Token required for protected routes.**
...
</details> ✅ **Pass – Invalid JWT correctly blocked.**
...
</details> ✅ **Pass – Invalid role input rejected.**
...
</details> ✅ **Pass – Admin self-deletion prevented.**
...
</details> ✅ **Pass – Cannot delete other admins.**
...
</details> ✅ **Pass – Security headers successfully verified.**
Test Case 20 – Input Sanitization
<details> <summary>Request & Response</summary>
Endpoint: POST /api/auth/login (or any endpoint accepting user input)
...
</details> ✅ **Pass – Input sanitization confirmed.**
